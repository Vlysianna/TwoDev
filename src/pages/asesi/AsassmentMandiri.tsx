	...
	const fetchUnitCompetencies = async (assessmentCode: string) => {
		try {
			const response = await api.get(
				`/assessment/apl2/unit-competencies/${encodeURIComponent(
					assessmentCode
				)}`
			);
										...
										<div className="flex justify-between items-start flex-wrap gap-5">
											...
											<div className="lg:text-right sm:text-start">
												<h3 className="font-medium text-gray-800 mb-2">
													{selectedAssessment?.occupation?.name ||
							...
							<div className="lg:col-span-2 h-full">
								<div className="bg-white rounded-lg p-6 h-full">
									...
									<div className="mb-6 flex justify-center">
										<div className="p-4 bg-white border rounded-lg w-full flex justify-center py-10">
											<img
