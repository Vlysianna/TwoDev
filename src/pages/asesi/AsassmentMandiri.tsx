                                ...
                                <div className="bg-white rounded-lg p-6 h-full">
                                    ...
                                    <div className="mb-6">
                                        <div className="flex justify-between items-center mb-2">
                                            ...
                                            <span className="text-sm font-medium text-[#E77D35]">35%</span>
                                        </div>
                                        <div className="w-full bg-gray-200 rounded-full h-3">
                                            <div className="bg-[#E77D35] h-3 rounded-full transition-all duration-300" style={{ width: '35%' }}></div>
                                        </div>
                                    </div>
                                    ...
                                    <div className="mb-6 flex justify-center">
                                        <div className="p-4 bg-white border rounded-lg w-full flex justify-center">
                                            <img
                                    ...
                                    <div className="w-full">
                                        <Link
                                            to={paths.asesi.asesmenMandiriDetail} // arahkan ke route yang kamu mau
                                            className={`w-full block text-center bg-[#E77D35] hover:bg-orange-600 text-white font-medium py-3 px-4 rounded-md transition duration-200 focus:outline-none focus:ring-2 focus:ring-orange-500 focus:ring-offset-2 ${!selectedAssessor || !selectedDate ? "bg-gray-300 pointer-events-none" : ""
                                                }`}
                                        >
                                            Lanjut
                                        </Link>
