...
export default function DashboardAsesmenMandiri() {
  ...
  const handleActionClick = (assesseeId: number) => {
    switch (selectedTab) {
      ...
      case "ia-01":
        navigate(
          paths.asesor.assessment.ia01(id_assessment, assesseeId)
        )
        break;
      case "ia-02":
        navigate(
          paths.asesor.assessment.ia02(id_assessment, assesseeId)
        )
        break;
      case "ia-03":
        navigate(
          paths.asesor.assessment.ia03(id_assessment, assesseeId)
        )
        break;
      case "ia-05":
        // navigate(
      ...
      case "ak-01":
        navigate(
          paths.asesor.assessment.ak01(id_assessment, assesseeId)
        );
        break;
      case "ak-02":
        navigate(
          paths.asesor.assessment.ak02(id_assessment, assesseeId)
        )
        break;
      case "ak-05":
        navigate(
          paths.asesor.assessment.ak05(id_assessment, assesseeId)
        )
        break;
    }
  };
