        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6 w-full mt-4 md:mt-6">
          <div className="w-full">
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-4 md:gap-6">
              ...
              <div className="lg:col-span-6 order-1">
                <h2 className="text-sm md:text-base font-semibold text-gray-800 mb-3 md:mb-6">
                  Umpan Balik
                </h2>
                  ...
                  <div className="flex flex-col md:flex-row gap-3 md:gap-6">
                    {feedbackOptions.map((option) => (
                      ...
                      >
                        ...
                        <span
                          className={`${feedbackResult === option.key ? "text-gray-900" : "text-gray-500"} whitespace-nowrap text-xs md:text-sm`}
                        >
                          {option.label}
                        </span>
                      </label>
                ...
                <div className="mb-4">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-3 md:gap-4 mb-3 md:mb-4">
                    <div>
                      <label className="block text-xs md:text-sm text-gray-700 mb-1">Unit</label>
                      <input
                        type="text"
                        value={unitField}
                        onChange={(e) => setUnitField(e.target.value)}
                        className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-[#E77D35] focus:border-[#E77D35] text-xs md:text-sm bg-white"
                      />
                    </div>
                    <div>
                      <label className="block text-xs md:text-sm text-gray-700 mb-1">Elemen</label>
                      <input
                        type="text"
                        value={elementField}
                  ...
                  <div>
                    <label className="block text-xs md:text-sm text-gray-700 mb-1">KUK</label>
                    <input
                      type="text"
                      value={kukField}
                ...
                <div className="mb-6 md:mb-8">
                  ...
                  <div className="mb-2 md:mb-3">
                    <input
                      ...
                      className="w-full px-2 sm:px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-[#E77D35] focus:border-[#E77D35] text-xs md:text-sm bg-gray-100"
                  ...
                  <div className="flex items-center space-x-2">
                    <div className="flex-1">
                      <input
                        ...
                        className="w-full px-2 sm:px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-[#E77D35] focus:border-[#E77D35] text-xs md:text-sm bg-gray-100 cursor-pointer"
                        disabled
                      />
                    </div>
                    <div
              ...
              <div className="lg:col-span-2 order-3 flex flex-col items-center space-y-5 mb-5 md:mb-0">
                ...
                {/* Generate QR Button */}
                <button className="bg-[#E77D35] hover:bg-[#E77D35] text-white text-xs md:text-sm px-4 md:px-6 lg:px-12 py-2 rounded-md transition-colors duration-200 whitespace-nowrap">
                  Generate QR
                </button>
              </div>
            </div>
          ...
          <div className="flex justify-center md:justify-end mt-4 md:mt-6 lg:mt-8">
            <button
              ...
              className="bg-[#E77D35] hover:bg-[#E77D35] text-white text-xs md:text-sm font-medium px-8 md:px-12 lg:px-45 py-2 md:py-3 rounded-md transition-colors duration-200 w-full md:w-auto"
            >
              Lanjut
            </button>
          </div>
