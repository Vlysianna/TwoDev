      ...
      <div className="flex-1 flex flex-col min-w-0">
        ...
        <div className="p-3 sm:p-4 lg:p-6">
          <div className="mb-4 sm:mb-6">
            ...
            <h1 className="text-xl sm:text-2xl font-semibold text-gray-900">Kelola Okupasi</h1>
          </div>
          ...
          <div className="bg-white rounded-lg sm:rounded-xl shadow p-4 sm:p-6 mb-4 sm:mb-6 transition-all duration-300 hover:shadow-md">
            <h2 className="text-base sm:text-lg font-semibold mb-4">Tambah Okupasi</h2>
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6 mb-4">
              <div className="order-1 lg:order-1">
                <label className="block text-sm font-medium mb-2 text-gray-700">Pilih Jurusan</label>
          ...
          <div className="bg-white rounded-lg sm:rounded-xl shadow overflow-hidden">
            <div className="px-4 sm:px-6 py-4 border-b flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3 sm:gap-0">
              <h3 className="text-base sm:text-lg font-semibold">Daftar Okupasi</h3>
              ...
              <table className="w-full text-sm">
                <thead>
                  <tr className="bg-gradient-to-r from-[#E77D35] to-[#E77D35] text-white">
                    <th className="px-4 lg:px-6 py-4 text-left font-semibold">Nama Jurusan</th>
                    <th className="px-4 lg:px-6 py-4 text-left font-semibold">Okupasi</th>
                    <th className="px-4 lg:px-6 py-4 text-center font-semibold">Aksi</th>
                  </tr>
                </thead>
                <tbody>
                  {okupasiData.map((item, index) => (
          ...
          <div className="bg-white rounded-xl shadow-2xl w-full max-w-md relative z-10 max-h-[90vh] overflow-y-auto">
            <div className="p-4 sm:p-6">
              <div className="flex justify-between items-center mb-4 sm:mb-6">
                <h3 className="text-lg sm:text-xl font-semibold text-gray-900">Edit Okupasi</h3>
                <button 
                  ...
                  <div className="relative">
                    ...
                    >
                      <div className="flex items-center justify-between">
                        ...
                        <ChevronDown className={`w-4 h-4 text-gray-400 transition-transform flex-shrink-0 ${isEditDropdownOpen ? 'rotate-180' : ''}`} />
                      </div>
                    </button>
