...
const KelolaJurusan = () => {
	...
	const [jurusanList, setJurusanList] = useState([
		...
		{ id: 4, nama: "TBSM", deskripsi: "Teknik dan Bisnis Sepeda Motor" },
		{
			id: 5,
			nama: "OTKP",
			deskripsi: "Otomatisasi dan Tata Kelola Perkantoran",
		},
	]);
						...
						<div className="grid grid-cols-1 lg:grid-cols-2 gap-4 lg:gap-6">
							<div>
								...
								<input
									...
									onChange={(e) =>
										setFormData({ ...formData, namaJurusan: e.target.value })
									}
						...
						<div className="px-4 lg:px-6 py-4 border-t border-gray-200 bg-gray-50">
							<div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2">
								<div className="text-sm text-gray-700">
									Menampilkan{" "}
									<span className="font-medium">{jurusanList.length}</span> dari{" "}
									<span className="font-medium">{jurusanList.length}</span>{" "}
									entri
								</div>
