			...
			<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
				<div className="flex justify-between items-center h-16">
						...
						<div className="relative">
							...
							{activeDropdown === "layanan" && (
								<div className="absolute top-full left-0 mt-2 w-56 bg-white shadow-lg border rounded-md z-50 py-2">
									...
									<Link
										to={paths.dashboard.tempatUji}
										className="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100"
									>
										Tempat Uji
									</Link>
									<Link
										to={paths.dashboard.asesor}
										className="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100"
									>
										Asesor
									</Link>
									<Link
										to={paths.dashboard.prosedurPendaftaran}
										className="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100"
									>
					...
					<div className="hidden md:block">
						<Link
							className="bg-[#E77D35] hover:bg-orange-700 text-white px-5 py-2 rounded-md text-sm font-medium"
							to={paths.auth.login}
						>
							Login
						</Link>
