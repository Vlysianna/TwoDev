...
export default function IA02({ id_result }: { id_result: string }) {
      ...
      <div className="bg-white rounded-lg shadow-sm p-6">
        ...
        <div className="border-t border-gray-200 pt-4">
          ...
          <div className="mt-3 flex flex-col sm:flex-row gap-2">
            <button
              onClick={() => handleViewPDF(setGeneratingPdf, result?.schedule?.id.toString() ?? "")}
            ...
            <div>
              ...
              <div className="flex flex-col sm:flex-row sm:items-center gap-3">
                ...
                <input
                  ...
                  value={formatDateInputLocal(result?.schedule?.end_date).slice(
                    0,
                    10,
                  )}
                  disabled
